...
export default function PlacePage() {
            ...
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        ...
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black hover:bg-gray-300">
    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <a target="blank" className="flex gap-1 my-3 block font-semibold underline" href={'https:maps.google.com/?q=' + place.address}>
